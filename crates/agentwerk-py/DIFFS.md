...
| `CompactReason`, `PolicyKind`, `ToolFailureKind`, `RepairKind`, `ToolDeclineKind`, `KnowledgeFailureKind`, `KnowledgeOp` | Strings inside `Event.data`, under the field's own name: `data["policy"]`, `data["reason"]`, `data["op"]`. |
