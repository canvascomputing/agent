...
class TicketQueue:
    ...
    def max_turns(self, count: int) -> "TicketQueue": ...
    def max_input_tokens(self, count: int) -> "TicketQueue": ...
    def max_output_tokens(self, count: int) -> "TicketQueue": ...
    def max_request_tokens(self, count: int) -> "TicketQueue": ...
    def max_schema_retries(self, count: int) -> "TicketQueue": ...
    def max_request_retries(self, count: int) -> "TicketQueue": ...
    ...
    def on_event(self, handler: Callable[[Event], Any]) -> "TicketQueue": ...
    def on_result(
        self, handler: Callable[[Ticket, Any], Any]
    ) -> "TicketQueue": ...
    def on_result_async(
        self, handler: Callable[[Ticket, Any], Awaitable[Any]]
    ) -> "TicketQueue": ...
    def on_results(
        self, handler: Callable[[list[Any]], Any]
    ) -> "TicketQueue": ...
    def on_results_async(
        self, handler: Callable[[list[Any]], Awaitable[Any]]
    ) -> "TicketQueue": ...
    def on_failure(
        self, handler: Callable[[Event, Ticket], Any]
    ) -> "TicketQueue": ...
