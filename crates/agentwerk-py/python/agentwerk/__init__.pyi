...
class BashTool:
    """A shell command an agent may call, passed to ``Agent.tool(...)``."""

    def __init__(self, name: str) -> None: ...
    def allow(self, pattern: str) -> "BashTool": ...
    def deny(self, pattern: str) -> "BashTool": ...
    def description(self, description: str) -> "BashTool": ...
    def read_only(self, read_only: bool) -> "BashTool": ...

def UnrestrictedBashTool() -> BashTool: ...
