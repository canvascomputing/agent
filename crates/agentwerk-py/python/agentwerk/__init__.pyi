...
class Stats:
    ...
    def work_duration(self) -> TimeStat: ...
...
class TicketQueue:
    ...
    def is_label_cancelled(self, label: str) -> bool: ...
    ...
    def tickets_for_agent(self, agent_name: str) -> list[Ticket]: ...
    ...
    async def finish_on_event(
        self, condition: Callable[[Event], bool]
    ) -> Optional[Event]: ...
    async def finish_on_result(
        self, condition: Callable[[Ticket, Any], bool]
    ) -> Optional[tuple[Ticket, Any]]: ...
    async def finish_on_failure(
        self, condition: Callable[[Event, Ticket], bool]
    ) -> Optional[tuple[Event, Ticket]]: ...
    async def finish_on_ticket(
        self, condition: Callable[[Ticket], bool]
    ) -> Optional[Ticket]: ...
    def start(self) -> "TicketQueue": ...
    async def finish(self) -> "TicketQueue": ...
    ...
    def results_for_agent(self, agent_name: str) -> list[Any]: ...
    def result_for_ticket(self, key: str) -> Optional[Any]: ...
