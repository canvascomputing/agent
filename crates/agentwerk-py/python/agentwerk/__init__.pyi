...
class Queue:
    ...
    def agent(self, agent: Agent) -> "Queue": ...
    def task(self, task: "Task | Any") -> str: ...
    def reply(self, key: str, content: str) -> "Queue": ...
    def set_finished(self, key: str, result: Any) -> None: ...
    def set_failed(self, key: str) -> None: ...
    def policy(self, policy: "Policy") -> "Queue": ...
    def get_policy(self) -> "Policy": ...
    def dir(self, dir: str) -> "Queue": ...
    def get_dir(self) -> str: ...
    def schemas(self, store: SchemaStore) -> "Queue": ...
    def on_event(
